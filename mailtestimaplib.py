...
def themailfunction():
  ...
  #for x in range(i):This loop was through end of body details.  removed, only want one email at a time
  latest_email_uid = data[0].split()[0]#Originally x
  ...
  for part in email_message.walk():
      if part.get_content_type() == "text/plain":
          ...
          file_name = "email_" + str(0) + ".txt"#str held x, now holds zero
