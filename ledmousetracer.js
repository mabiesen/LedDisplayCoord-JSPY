$(document).ready(function(){
	...
	//Function created to load clicked td into record. storing values and keys separately because animation may require
	...
	function createverbatim($anelement){
		verbatimkey.push(getclass($anelement,0));
